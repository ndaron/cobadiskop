...
function beritaxx_customize_register( $wp_customize ) {
	
$wp_customize->add_panel('beritaxx_setting_customizer',array(
    'title'       => __( 'Theme Setting', 'beritaxx' ),
    'description' => __( 'General Theme Setting', 'beritaxx' ),
    'priority'    => 40,
));

$wp_customize->add_section('header_mode',array(
    'title'       => __( 'Default Header', 'beritaxx' ),
    'description' => __( 'Choose default layout for Header', 'beritaxx' ),
    'priority'    => 10,
    'panel'       => 'beritaxx_setting_customizer',
));
...
$wp_customize->add_control('header_switch',array(
	'description'  => __( 'Choose Layout', 'beritaxx' ),
    'type'         => 'select',
	'choices'      => array(
		'header-one'  => __( 'Header + Dropdown Menu', 'beritaxx' ),
		'default'  => __( 'Default', 'beritaxx' ),
	),
    'section'      => 'header_mode',
    'settings'     => 'header_switch',
));

$wp_customize->add_section('beritaxx_loop_layout',array(
    'title'       => __( 'Default Loop', 'beritaxx' ),
    'description' => __( 'Choose default layout for Post list on page like Homepage, Archive, Tags, Category, Author, and Search', 'beritaxx' ),
    'priority'    => 10,
    'panel'       => 'beritaxx_setting_customizer',
));

$wp_customize->add_setting('loop_by_user',array(
    'default'     => 'default',
	'transport'   => 'postMessage',
	'sanitize_callback' => 'wp_kses_post'
));
$wp_customize->add_control('loop_by_user',array(
	'description'  => __( 'Choose Layout', 'beritaxx' ),
    'type'         => 'select',
	'choices'      => array(
		'classic'  => __( 'Classic + Sidebar', 'beritaxx' ),
		'block'    => __( 'Block', 'beritaxx' ),
		'default'  => __( 'Default', 'beritaxx' ),
	),
    'section'      => 'beritaxx_loop_layout',
    'settings'     => 'loop_by_user',
));


$wp_customize->add_section('beritaxx_setting_font',array(
    'title'       => 'Fonts',
	'description' => __( 'This theme use 1400+ fonts from Google Font.', 'beritaxx' ),
    'priority'    => 10,
    'panel'       => 'beritaxx_setting_customizer',
));
...
$wp_customize->add_setting('beritaxxfont_global',array(
    'default'     => '',
	'transport'   => 'refresh',
	'sanitize_callback' => 'web_sanitize_fonts'
));
$wp_customize->add_control('beritaxxfont_global',array(
    'label'        => __( 'Global', 'beritaxx' ),
	'description'  => __( 'Font Family', 'beritaxx' ),
    'type'         => 'select',
	'choices'      => $font_choices,
    'section'      => 'beritaxx_setting_font',
    'settings'     => 'beritaxxfont_global',
));
$wp_customize->add_setting('beritaxxfontsize_global',array(
    'default'     => 14,
	'transport'   => 'refresh',
	'sanitize_callback' => 'absint'
));
$wp_customize->add_control('beritaxxfontsize_global',array(
	'description'  => __( 'Font Size', 'beritaxx' ),
    'type'         => 'number',
	'input_attrs' => array(
        'min'     => 13,
		'max'     => 16,
    ...
    'section'      => 'beritaxx_setting_font',
    'settings'     => 'beritaxxfontsize_global',
));

$wp_customize->add_setting('beritaxxfont_heading',array(
    'default'     => '',
	'transport'   => 'refresh',
	'sanitize_callback' => 'web_sanitize_fonts'
));
$wp_customize->add_control('beritaxxfont_heading',array(
    'label'        => __( 'Heading', 'beritaxx' ),
    'type'         => 'select',
	'choices'      => $font_choices,
    'section'      => 'beritaxx_setting_font',
    'settings'     => 'beritaxxfont_heading',
));

$wp_customize->add_setting('beritaxxfontsize_article',array(
    'default'     => 16,
	'transport'   => 'refresh',
	'sanitize_callback' => 'absint'
));
$wp_customize->add_control('beritaxxfontsize_article',array(
	'description'  => __( 'Article Font Size', 'beritaxx' ),
    'type'         => 'number',
	'input_attrs' => array(
        'min'     => 13,
		'max'     => 18,
    ...
    'section'      => 'beritaxx_setting_font',
    'settings'     => 'beritaxxfontsize_article',
));

$wp_customize->add_section('beritaxx_setting_thumbnail',array(
    'title'       => __( 'Thumbnail', 'beritaxx' ),
	'description' => __( 'Add default image to replace if post dont have thumbnail', 'beritaxx' ),
    'priority'    => 10,
    'panel'       => 'beritaxx_setting_customizer',
));

$wp_customize->add_setting( 'beritaxx_default_thumbnail', array(
    'default' => '',
    'sanitize_callback' => 'esc_url_raw'
));
 
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'beritaxx_default_thumbnail', array(
    'label'      => __( 'Thumbnail Post', 'beritaxx' ),
    'section'    => 'beritaxx_setting_thumbnail',
    'settings'   => 'beritaxx_default_thumbnail',
    'button_labels' => array(
        'select' => __( 'Choose Image', 'beritaxx' ),
        'remove' => __( 'Remove Image', 'beritaxx' ),
        'change' => __( 'Change Image', 'beritaxx' ),
    )
)));

$wp_customize->add_setting( 'beritaxx_default_thumbnail_share', array(
    'default' => '',
    'sanitize_callback' => 'esc_url_raw'
));
 
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'beritaxx_default_thumbnail_share', array(
    'label'       => __( 'Thumbnail Share', 'beritaxx' ),
	'description' => '',
    'section'     => 'beritaxx_setting_thumbnail',
    'settings'    => 'beritaxx_default_thumbnail_share',
    'button_labels' => array(
        'select' => __( 'Choose Image', 'beritaxx' ),
        'remove' => __( 'Remove Image', 'beritaxx' ),
        'change' => __( 'Change Image', 'beritaxx' ),
...
$wp_customize->add_section('beritaxx_setting_theme',array(
    'title'       => __( 'Social Media', 'beritaxx' ),
    'priority'    => 10,
    'panel'       => 'beritaxx_setting_customizer',
));
...
$wp_customize->add_control('facebook_data',array(
    'label'        => __( 'Facebook', 'beritaxx' ),
    'type'         => 'url',
    'section'      => 'beritaxx_setting_theme',
    'settings'     => 'facebook_data',
	'input_attrs' => array(
        'placeholder' => __( 'https://...', 'beritaxx' ),
    )
));
// Twitter
...
$wp_customize->add_section('beritaxx_setting_ads',array(
    'title'       => __( 'Ads Slots', 'beritaxx' ),
    'priority'    => 10,
    'panel'       => 'beritaxx_setting_customizer',
));
$wp_customize->add_setting('beritaxx_ads_afterheader',array(
    'default'     => '',
	'transport'   => 'postMessage',
	'sanitize_callback' => 'esc_textarea'
));
$wp_customize->add_control('beritaxx_ads_afterheader',array(
    'label'       => __( 'After Header', 'beritaxx' ),
    'type'        => 'textarea',
    'section'     => 'beritaxx_setting_ads',
    'settings'    => 'beritaxx_ads_afterheader',
));
$wp_customize->add_setting('beritaxx_left_floating',array(
    'default'     => '',
	'transport'   => 'postMessage',
	'sanitize_callback' => 'esc_textarea'
));
$wp_customize->add_control('beritaxx_left_floating',array(
    'label'       => __( 'Floating Left', 'beritaxx' ),
    'type'        => 'textarea',
    'section'     => 'beritaxx_setting_ads',
    'settings'    => 'beritaxx_left_floating',
));
$wp_customize->add_setting('beritaxx_right_floating',array(
    'default'     => '',
	'transport'   => 'postMessage',
	'sanitize_callback' => 'esc_textarea'
));
$wp_customize->add_control('beritaxx_right_floating',array(
    'label'       => __( 'Floating Right', 'beritaxx' ),
    'type'        => 'textarea',
    'section'     => 'beritaxx_setting_ads',
    'settings'    => 'beritaxx_right_floating',
));
$wp_customize->add_setting('beritaxx_ads_beforefooter',array(
    'default'     => '',
	'transport'   => 'postMessage',
	'sanitize_callback' => 'esc_textarea'
));
$wp_customize->add_control('beritaxx_ads_beforefooter',array(
    'label'       => __( 'Before Footer', 'beritaxx' ),
    'type'        => 'textarea',
    'section'     => 'beritaxx_setting_ads',
    'settings'    => 'beritaxx_ads_beforefooter',
));

$wp_customize->add_setting('beritaxx_ads_bottom',array(
    'default'     => '',
	'transport'   => 'postMessage',
	'sanitize_callback' => 'esc_textarea'
));
$wp_customize->add_control('beritaxx_ads_bottom',array(
    'label'       => __( 'Sticky Bottom', 'beritaxx' ),
    'type'        => 'textarea',
    'section'     => 'beritaxx_setting_ads',
    'settings'    => 'beritaxx_ads_bottom',
));
...
$wp_customize->add_control('inline_ads_one',array(
    'label'       => __( 'Inline Ads 1', 'beritaxx' ),
    'type'        => 'textarea',
    'section'     => 'beritaxx_setting_ads',
...
$wp_customize->add_control('inline_ads_two',array(
    'label'       => __( 'Inline Ads 2', 'beritaxx' ),
    'type'        => 'textarea',
    'section'     => 'beritaxx_setting_ads',
    'settings'    => 'inline_ads_two',
));

$wp_customize->add_section('beritaxx_setting_pixel',array(
    'title'       => __( 'Facebook Pixel', 'beritaxx' ),
    'priority'    => 10,
    'panel'       => 'beritaxx_setting_customizer',
));

$wp_customize->add_setting('beritaxx_pixel_code',array(
    'default'     => '',
	'transport'   => 'postMessage',
	'sanitize_callback' => 'wp_kses_post'
));
$wp_customize->add_control('beritaxx_pixel_code',array(
    'label'       => __( 'Insert Pixel ID', 'beritaxx' ),
    'type'        => 'text',
    'section'     => 'beritaxx_setting_pixel',
    'settings'    => 'beritaxx_pixel_code',
));

$wp_customize->add_section('beritaxx_setting_footertext',array(
    'title'       => __( 'Footer Area', 'beritaxx' ),
    'priority'    => 10,
    'panel'       => 'beritaxx_setting_customizer',
));

$wp_customize->add_setting( 'beritaxx_footer_logo', array(
    'default' => '',
	'transport'   => 'postMessage',
    'sanitize_callback' => 'esc_url_raw'
));
 
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'beritaxx_footer_logo', array(
    'label' => __( 'Footer Logo', 'beritaxx' ),
	'description' => '',
    'section' => 'beritaxx_setting_footertext',
    'settings' => 'beritaxx_footer_logo',
    'button_labels' => array(
        'select' => __( 'Choose Image', 'beritaxx' ),
        'remove' => __( 'Remove Image', 'beritaxx' ),
        'change' => __( 'Change Image', 'beritaxx' ),
...
$wp_customize->add_setting('beritaxx_footer_text',array(
    'default'     => __( 'Fresh design for News category WordPress theme', 'beritaxx' ),
	'transport'   => 'postMessage',
	'sanitize_callback' => 'wp_kses_post'
));
$wp_customize->add_control('beritaxx_footer_text',array(
    'label'       => __( 'Footer Text', 'beritaxx' ),
    'type'        => 'textarea',
    'section'     => 'beritaxx_setting_footertext',
    'settings'    => 'beritaxx_footer_text',
));
$wp_customize->add_setting('beritaxx_footer_copyright',array(
    'default'     => '',
	'transport'   => 'postMessage',
	'sanitize_callback' => 'wp_kses_post'
));
$wp_customize->add_control('beritaxx_footer_copyright',array(
    'label'       => __( 'Footer Copyright', 'beritaxx' ),
    'type'        => 'textarea',
    'section'     => 'beritaxx_setting_footertext',
    'settings'    => 'beritaxx_footer_copyright',
));

}
add_action( 'customize_register', 'beritaxx_customize_register', 11 );
